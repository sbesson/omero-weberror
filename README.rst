...
This is due to a Django Framework compatibility and to a required package reorganization in OMERO.weberror in version 0.2.0 so the application can be distributed from Python Package Index `PyPi <https://https://pypi.python.org/pypi>`_.
